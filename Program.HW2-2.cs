...
namespace Homework2
{
    class Program
    {
        ...
        public static Student CreateNewStudent()
        {
            return new Student(InputName(), InputAddress(),
                InputCitizenID(), InputStudentID(),InputBirthday());
        }
    ...
    class NewInformation
    {
        ...
        public static Teacher CreateNewTeacher()
        {
            ...
            InputEmployeeID(), Program.InputBirthday());
    ...
    class Person
    {
        ...
        public Person(string name, string address, string citizenID, string birthday)
        { 
            this.Name = name;
    ...
    class Student : Person
    {
        ...
        public Student(string name, string address, string citizenID, string studentID,string birthday) : base(name, address, citizenID,birthday)
        {
    ...
    class Teacher : Person
    {
        ...
        public Teacher(string name, string address, string citizenID, string teacherID, string birthday) : base(name, address, citizenID,birthday)
        {
